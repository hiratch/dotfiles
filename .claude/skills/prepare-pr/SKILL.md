...
3. **Verification（検証）**: 動作確認の方法・テスト計画。**まず full suite を実行し、その passed/failed 数を先頭に書く**（対象テストだけの結果で代替しない）。期待値 fixture を再生成した場合はその件数と差分の説明を、個別テストへの言及は full suite の結果の後に添える。
